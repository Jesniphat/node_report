  ...
  PH: [
    {
      ...
      items: [
        ...
        { type: 'text', align: 'right', bold: true, fontSize: 22, w: 200, h: 22, x: 338, y: 0, text: 'รายการสถิติแยกตามสัญชาติ', },
        ...
        { type: 'text', align: 'left', fontSize: 11, w: 360, h: 16, lineHeight:0.7, x: 100, y: 45, text: 'สัญชาติ', },
  ...
  DT: [
    {
      ...
      items: [
        ...
        { type: 'text', align: 'center', fontSize: 11, w: 65, h: 16, lineHeight:0.7, x: 35, y: 0, field: 'code', },
        { type: 'text', align: 'left', fontSize: 11, w: 360, h: 16, lineHeight:0.7, x: 100, y: 0, field: 'nation_en', },
